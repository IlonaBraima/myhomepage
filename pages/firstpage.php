...
<body>
    <div>
	    <div class="header">
		    ...
		    <div class="menu">
			    <div class="menu-item"><a class="menu-link" href="../uzdevumi/maniuzdevumi.html">Mājas uzdevums</a></div>
			    <div class="menu-item"><a class="menu-link" href="date.php">Проект: Мои 100 свиданий</a></div>
			    <div class="menu-item"><a class="menu-link" href="children.php">Проект: Дети</a></div>
			    <div class="menu-item"><a class="menu-link" href="QA.php">Проект: QA/Software tester</a></div>
    ...
    <p>
        Сильный, смелый, рассудительный, увлечённый, интересный, увлекающийся.
    </p>
